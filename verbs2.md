...
2. 被動、可能助動詞「れる・られる」（_受身形/可能形_）
3. 使役助動詞「せる・させる」（_使役形_）
4. 意志、推量助動詞「う・よう」（_意志形/意向形/推量形_）
...
## 五段动词的**特殊**连用形（_て形・た形_）
在 **后续助动词て・た** 等时，常会发生音便，音便规则如下：
- く・ぐ→い　
- す→し
- ぶ・む・ぬ→ん
- つ・る・う→っ
